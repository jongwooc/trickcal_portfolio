...
_DATAPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='data_source', full_name='caffe.DataParameter.data_source', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='label_source', full_name='caffe.DataParameter.label_source', index=11,
