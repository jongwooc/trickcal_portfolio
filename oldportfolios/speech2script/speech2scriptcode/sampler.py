...
class Script_Sentence(object):
    def __init__(self,subject_list,object_list,verb_list,combined_verb_list,adverb_list, mode):
...
class Functional_Script_Sentence(Script_Sentence):
    def __init__(self,name_subject,name_object,name_adverb,
                subject_list,object_list,verb_list,combined_verb_list,adverb_list, mode):
        self.script = str(name_subject + "." + name_object + name_adverb + "()")
        super().__init__(subject_list,object_list,verb_list,combined_verb_list,adverb_list, mode)
...
class Sentence_generator(object):
        ...
        for i in self._target_object.sentence_verb:
            for j in self._target_object.sentence_object:
                for k in self._target_object.sentence_subject:
                    sample_sentence = str(i + " " + j + " of " + k)
                    self._target_object.complete_sentence_v.append(sample_sentence)
                    sample_sentence = str(i + " " + j + " by " + k)
                    self._target_object.complete_sentence_v.append(sample_sentence)
                    sample_sentence = str(i + " " + j + " with " + k)
                    self._target_object.complete_sentence_v.append(sample_sentence)
    ...
    def cosa(self):
        for i in self._target_object.sentence_combined_verb:
            for j in self._target_object.sentence_object:
                for k in self._target_object.sentence_subject:
                    for l in self._target_object.sentence_adverb:
                        sample_sentence = str(i + " " + j + " of " + k + " " + l)
                        self._target_object.complete_sentence_v.append(sample_sentence)
                        sample_sentence = str(i + " " + j + " by " + k + " " + l)
                        self._target_object.complete_sentence_v.append(sample_sentence)
                        sample_sentence = str(i + " " + j + " with " + k + " " + l)
                        self._target_object.complete_sentence_v.append(sample_sentence)
            ...
            for j in self._target_object.sentence_adverb:
                for k in self._target_object.sentence_object:
                    for l in self._target_object.sentence_subject:
                        sample_sentence = str(i + " " + j + " " + k + " of " + l)
                        self._target_object.complete_sentence_v.append(sample_sentence)
                        sample_sentence = str(i + " " + j + " " + k + " by " + l)
                        self._target_object.complete_sentence_v.append(sample_sentence)
                        sample_sentence = str(i + " " + j + " " + k + " with " + l)
                        self._target_object.complete_sentence_v.append(sample_sentence)
    ...
    def osv(self):
        for i in self._target_object.sentence_object:
            for j in self._target_object.sentence_subject:
                for k in self._target_object.sentence_verb:
                    sample_sentence = str(i + " of " + j + " " + k)
                    self._target_object.complete_sentence_so.append(sample_sentence)
                    sample_sentence = str(i + " by " + j + " " + k)
                    self._target_object.complete_sentence_so.append(sample_sentence)
                    sample_sentence = str(i + " with " + j + " " + k)
                    self._target_object.complete_sentence_so.append(sample_sentence)
    #osca
    def osca(self):
        for i in self._target_object.sentence_object:
            for j in self._target_object.sentence_subject:
                for k in self._target_object.sentence_combined_verb:
                    for l in self._target_object.sentence_adverb:
                        sample_sentence = str(i + " of " + j + " " + k + " " + l)
                        self._target_object.complete_sentence_so.append(sample_sentence)
                        sample_sentence = str(i + " by " + j + " " + k + " " + l)
                        self._target_object.complete_sentence_so.append(sample_sentence)
                        sample_sentence = str(i + " with " + j + " " + k + " " + l)
                        self._target_object.complete_sentence_so.append(sample_sentence)
    ...
    def scoai(self):
        for i in self._target_object.sentence_subject :
            for j in self._target_object.sentence_combined_verb:
                for k in self._target_object.sentence_object:
                    for l in self._target_object.sentence_adverb:
                        sample_sentence = str(i + " " + j + " " + k + " " + l + " " + str(self._target_object.int_value))
                        self._target_object.complete_sentence_so.append(sample_sentence)
    ...
    def soi(self):
        for i in self._target_object.sentence_subject :
            for j in self._target_object.sentence_object:
                sample_sentence = str(i + " " + j + " " + str(self._target_object.int_value))
                self._target_object.complete_sentence_so.append(sample_sentence)
    ...
    def vois(self):
        for i in self._target_object.sentence_verb:
            for j in self._target_object.sentence_object:
                for k in self._target_object.sentence_subject:
                    sample_sentence = str(i + " " + j +  " " + str(self._target_object.int_value) + " of " + k)
                    self._target_object.complete_sentence_v.append(sample_sentence)
                    sample_sentence = str(i + " " + j +  " " + str(self._target_object.int_value) + " by " + k)
                    self._target_object.complete_sentence_v.append(sample_sentence)
                    sample_sentence = str(i + " " + j +  " " + str(self._target_object.int_value) + " with " + k)
                    self._target_object.complete_sentence_v.append(sample_sentence)
    ...
    def cosai(self):
        for i in self._target_object.sentence_combined_verb:
            for j in self._target_object.sentence_object:
                for k in self._target_object.sentence_subject:
                    for l in self._target_object.sentence_adverb:
                        sample_sentence = str(i + " " + j + " of " + k + " " + l + " " + str(self._target_object.int_value))
                        self._target_object.complete_sentence_v.append(sample_sentence)
                        sample_sentence = str(i + " " + j + " by " + k + " " + l + " " + str(self._target_object.int_value))
                        self._target_object.complete_sentence_v.append(sample_sentence)
                        sample_sentence = str(i + " " + j + " with " + k + " " + l + " " + str(self._target_object.int_value))
                        self._target_object.complete_sentence_v.append(sample_sentence)
    ...
    def caosi(self):
        for i in self._target_object.sentence_combined_verb:
            for j in self._target_object.sentence_adverb:
                for k in self._target_object.sentence_object:
                    for l in self._target_object.sentence_subject:
                        sample_sentence = str(i + " " + j + " " + k + " of " + l + " " + str(self._target_object.int_value))
                        self._target_object.complete_sentence_v.append(sample_sentence)
                        sample_sentence = str(i + " " + j + " " + k + " by " + l + " " + str(self._target_object.int_value))
                        self._target_object.complete_sentence_v.append(sample_sentence)
                        sample_sentence = str(i + " " + j + " " + k + " with " + l + " " + str(self._target_object.int_value))
                        self._target_object.complete_sentence_v.append(sample_sentence)
    ...
    def osvi(self):
        for i in self._target_object.sentence_object:
            for j in self._target_object.sentence_subject:
                for k in self._target_object.sentence_verb:
                    sample_sentence = str(i + " of " + j + " " + k + " " + str(self._target_object.int_value))
                    self._target_object.complete_sentence_so.append(sample_sentence)
                    sample_sentence = str(i + " by " + j + " " + k + " " + str(self._target_object.int_value))
                    self._target_object.complete_sentence_so.append(sample_sentence)
                    sample_sentence = str(i + " with " + j + " " + k + " " + str(self._target_object.int_value))
                    self._target_object.complete_sentence_so.append(sample_sentence)
    #oscai
    def oscai(self):
        for i in self._target_object.sentence_object:
            for j in self._target_object.sentence_subject:
                for k in self._target_object.sentence_combined_verb:
                    for l in self._target_object.sentence_adverb:
                        sample_sentence = str(i + " of " + j + " " + k + " " + l + " " + str(self._target_object.int_value))
                        self._target_object.complete_sentence_so.append(sample_sentence)
                        sample_sentence = str(i + " by " + j + " " + k + " " + l + " " + str(self._target_object.int_value))
                        self._target_object.complete_sentence_so.append(sample_sentence)
                        sample_sentence = str(i + " with " + j + " " + k + " " + l + " " + str(self._target_object.int_value))
                        self._target_object.complete_sentence_so.append(sample_sentence)
    #osai
    def osai(self):
        for i in self._target_object.sentence_object:
    ...
    def make_all(self):
        if self._target_object.mode == "SVO":
            self.svo()
            self.sov()
            self.scoa()
            self.scao()
            ...
            self.osca()
            self.osa()
        elif self._target_object.mode == "SV":
            self.sv()
            self.sca()
            self.sa()
            self.vs()
            self.csa()
            self.cas()
        elif self._target_object.mode == "int":
            self.svoi()
            self.sovi()
            self.scoai()
            self.scaoi()
            ...
            self.oscai()
            self.osai()
        elif self._target_object.mode == "dual":
            self.svo()
            self.sov()
            self.scoa()
            self.scao()
...
class Trigger_Script_Sentence(object):
    def __init__(self, conjuction, operand_container1, operator_12, operand_container2,
        ...
        if (operand_container1 is not None):
...
class Loop_Script_Sentence(Trigger_Script_Sentence):
    def __init__(self, cycle_number, cycle_time, operand_container1, operator_12, operand_container2, conjuction,
        ...
        if (operand_container1 is not None):
            self.script = self.script + ", " + operand_container1.script + " " +operator_12 + " " + operand_container2.script
        if (conjuction is not None):
            self.script = self.script + " " + conjuction + " " + operand_container3.script + " " + operator_34 + " " + operand_container4.script
        self.script = self.script + ")"
        super().__init__(conjuction, operand_container1, operator_12, operand_container2,
    ...
    def __init__(self,target_object):
        ...
        for trigger in self._target_object.trigger_list:
            for operand1 in self._target_object.operand1_list:
                for operator1 in self._target_object.operator12_list:
                    for operand2 in self._target_object.operand2_list:
                        sample_sentence = str(trigger + " while " + operand1 + " is " + operator1 + " " + operand2 + " ")
                        self._target_object.complete_phrase.append(sample_sentence)
...
#==============================functional sentences==============================#
    ...
    microphonevolumeup = Functional_Script_Sentence("microphone","volume","up",["microphone","mike"],
                    ...
                    ["turn","change"],["up","louder","higher"],"SVO")
    ...
    cameradetectpeople = Functional_Script_Sentence("camera","detect","people",["camera", "cam", "CCTV", "vision sensor"],
                    ["people","person","man","men","woman","women","human","boy","girl"],
                    ["detect","distinguish","find"],
                    [],[],"SVO")
    ...
    cameradetectsign = Functional_Script_Sentence("camera","detect","sign",["camera", "cam", "CCTV", "vision sensor"],
                    ["sign","road sign", "traffic sign", "street sign", "mark", "road mark"],
                    ["detect","distinguish","find"],
                    [],[],"SVO")
    ...
    airconditionertemperatureup = Functional_Script_Sentence("airconditioner","temperature","up", ["air conditioner", "air-con", "air cooler", "air cooling device"],
               ["temperature", "target temperature","air temperature","room temperature"],
               ["raise","increase","make hotter","make warmer"],
               ["change"],["up", "hotter", "warmer"],"SVO")
    ...
    heatertemperatureup = Functional_Script_Sentence("heater","temperature","up", ["heater", "boiler", "warmer", "heating device", "heating system", "radiator"],
                  ["temperature", "heat","target temperature","room temperature"],
                  ["raise","increase"],
                  ["change"],["up", "hotter", "warmer"],"SVO")
...
#==============================functional sentences==============================#
    ...
    powermeter_watt = operand_container("powermeter.watt",
                            ["power","watt","watt from power meter",
    ...
    lightsensor_brightness = operand_container("lightsensor.brightness",
                            ["brightness","environmental brightness", "surrounding brightness", "ambient brightness",
...
#==============================trigger & loop generator==============================#
    ...
    f_script= open("script.txt","a+")
    f_sentence= open("sentence.txt","a+")
    ...
    if ((os.path.exists("trigger_script.txt")==False) and (os.path.exists("trigger_script.txt"))==False):
        ...
        for i in range(5000):
            ...
            temp_loop1 = Loop_Script_Sentence(i%60+1, random.choice(cycle_unit), None,None,None, None, None, None, None)
            loop0_generator(temp_loop1)
            f_trigger_script.write(repr(temp_loop1.script +" {\n")[1:-1])
            f_trigger_sentence.write(random.choice(temp_loop1.complete_phrase))
            f_trigger_script.write("\n")
            f_trigger_sentence.write("\n")

            temp_loop2 = Loop_Script_Sentence(i%60+1, random.choice(cycle_unit), operand_list[(i+7)%operand_list_len], operator_list[(i+7)%operator_list_len],int_container_999[i%100], None, None, None, None)
            loop1_generator(temp_loop2)
            f_trigger_script.write(repr(temp_loop2.script +" {\n")[1:-1])
            f_trigger_sentence.write(random.choice(temp_loop2.complete_phrase))
            f_trigger_script.write("\n")
            f_trigger_sentence.write("\n")

            temp_loop3 = Loop_Script_Sentence(i%60+1, random.choice(cycle_unit), operand_list[(i+8)%operand_list_len], operator_list[(i+8)%operator_list_len],int_container_999[i%100], "or", random.choice(operand_list), random.choice(operator_list), random.choice(int_container_999))
            loop2_generator(temp_loop3)
            f_trigger_script.write(repr(temp_loop3.script +" {\n")[1:-1])
            f_trigger_sentence.write(random.choice(temp_loop3.complete_phrase))
            f_trigger_script.write("\n")
            f_trigger_sentence.write("\n")

            temp_loop4 = Loop_Script_Sentence(i%60+1, random.choice(cycle_unit), operand_list[(i+9)%operand_list_len], operator_list[(i+9)%operator_list_len],int_container_999[i%100], "and", random.choice(operand_list), random.choice(operator_list), random.choice(int_container_999))
            loop2_generator(temp_loop4)
            f_trigger_script.write(repr(temp_loop4.script +" {\n")[1:-1])
            f_trigger_sentence.write(random.choice(temp_loop4.complete_phrase))
            f_trigger_script.write("\n")
            f_trigger_sentence.write("\n")
    ...
    for i in range(500000):
        ...
        temp_loop1 = Loop_Script_Sentence(i%60+1, random.choice(cycle_unit), None, None, None, None, None, None, None)
        loop0_generator(temp_loop1)
        loop_phrase_list.append([temp_loop1.script,random.choice(temp_loop1.complete_phrase)])
            
        temp_loop2 = Loop_Script_Sentence(i%60+1, random.choice(cycle_unit), operand_list[(i+7)%operand_list_len], operator_list[(i+7)%operator_list_len],int_container_999[i%100], None, None, None, None)
        loop1_generator(temp_loop2)
        loop_phrase_list.append([temp_loop2.script,random.choice(temp_loop2.complete_phrase)])

        temp_loop3 = Loop_Script_Sentence(i%60+1, random.choice(cycle_unit), operand_list[(i+8)%operand_list_len], operator_list[(i+8)%operator_list_len],int_container_999[i%100], "or", random.choice(operand_list), random.choice(operator_list), random.choice(int_container_999))
        loop2_generator(temp_loop3)
        loop_phrase_list.append([temp_loop3.script,random.choice(temp_loop3.complete_phrase)])

        temp_loop4 = Loop_Script_Sentence(i%60+1, random.choice(cycle_unit), operand_list[(i+9)%operand_list_len], operator_list[(i+9)%operator_list_len],int_container_999[i%100], "and", random.choice(operand_list), random.choice(operator_list), random.choice(int_container_999))
        loop2_generator(temp_loop4)
        loop_phrase_list.append([temp_loop4.script,random.choice(temp_loop4.complete_phrase)])
    #==============================trigger & loop generator==============================#
        ...
        for temp_trigger in trigger_phrase_list:
            ...
            samplescrpit = temp_trigger[0] + " {\n" + total_functional_sentence_list_so[i%total_functional_sentence_list_so_len][0] + "\n}"
            samplesentence = temp_trigger[1] + " make " + total_functional_sentence_list_so[i%total_functional_sentence_list_so_len][1]
            f_script.write(repr(samplescrpit)[1:-1])
            f_sentence.write(samplesentence)
            f_script.write("\n")
            f_sentence.write("\n")
            
            samplescrpit = temp_trigger[0] + " {\n" + total_functional_sentence_list_v[i%total_functional_sentence_list_v_len][0] + "\n}"
            samplesentence = temp_trigger[1] + " " + total_functional_sentence_list_v[i%total_functional_sentence_list_v_len][1]
            f_script.write(repr(samplescrpit)[1:-1])
            f_sentence.write(samplesentence)
            f_script.write("\n")
            f_sentence.write("\n")
            ...
            samplescrpit = temp_trigger[0] + " {\n" + total_functional_sentence_list_v[i%total_functional_sentence_list_v_len][0] + "\n}"
            samplesentence = total_functional_sentence_list_so[i%total_functional_sentence_list_so_len][1] + " " + temp_trigger[1]
            f_script.write(repr(samplescrpit)[1:-1])
            f_sentence.write(samplesentence)
            f_script.write("\n")
            f_sentence.write("\n")
            ...
            samplescrpit = temp_trigger[0] + " {\n" + total_functional_sentence_list_v[i%total_functional_sentence_list_v_len][0] + "\n}"
            samplesentence = total_functional_sentence_list_v[i%total_functional_sentence_list_v_len][1] + " " + temp_trigger[1]
            f_script.write(repr(samplescrpit)[1:-1])
            f_sentence.write(samplesentence)
            f_script.write("\n")
            f_sentence.write("\n")
        ...
        for temp_loop in loop_phrase_list:
            ...
            samplesentence = total_functional_sentence_list_v[i%total_functional_sentence_list_v_len][1] + " " + temp_loop[1]
            f_script.write(repr(samplescrpit)[1:-1])
            f_sentence.write(samplesentence)
            f_script.write("\n")
            f_sentence.write("\n")
    ...
    for i in range(20000):
        ...
        for j in range(200):
            ...
            temp_loop2 = Loop_Script_Sentence(i%60+1, random.choice(cycle_unit), random.choice(operand_list), random.choice(operator_list),int_container_999[i%100], None, None, None, None)
            loop1_generator(temp_loop2)
            for item in temp_loop2.complete_phrase:
                loop_phrase_list.append([temp_loop2.script,item])

            temp_loop3 = Loop_Script_Sentence(i%60+1, random.choice(cycle_unit), random.choice(operand_list), random.choice(operator_list),int_container_999[i%100], "or", random.choice(operand_list), random.choice(operator_list), random.choice(int_container_999))
            loop2_generator(temp_loop3)
            for item in temp_loop3.complete_phrase:
                loop_phrase_list.append([temp_loop3.script,item])

            temp_loop4 = Loop_Script_Sentence(i%60+1, random.choice(cycle_unit), random.choice(operand_list), random.choice(operator_list),int_container_999[i%100], "and", random.choice(operand_list), random.choice(operator_list), random.choice(int_container_999))
            loop2_generator(temp_loop4)
            for item in temp_loop4.complete_phrase:
                loop_phrase_list.append([temp_loop4.script,item])
    ...
    for i in range(1000):
        ...
        for j in range(20):
            ...
            temp_loop3 = Loop_Script_Sentence(i%60+1, random.choice(cycle_unit),random.choice(operand_list), random.choice(operator_list),int_container_999[i%100], "and", random.choice(operand_list), random.choice(operator_list), random.choice(int_container_999))
            loop2_generator(temp_loop3)
            for item in temp_loop3.complete_phrase:
                loop_phrase_list.append([temp_loop3.script,item])

            temp_loop4 = Loop_Script_Sentence(str(random.randint(1,99)), random.choice(cycle_unit),random.choice(operand_list), random.choice(operator_list),random.choice(int_container_999), "or", random.choice(operand_list), random.choice(operator_list), random.choice(int_container_999))
            loop2_generator(temp_loop4)
            for item in temp_loop4.complete_phrase:
                loop_phrase_list.append([temp_loop4.script,item])
