...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_MiniSplitte.CreateStatic(&m_MainSplitte,2,1
		,WS_CHILD | WS_VISIBLE ,m_MainSplitte.IdFromRowCol(0,0));
	...
	m_MainSplitte.CreateView(0,1,RUNTIME_CLASS(CMaptoolView),CSize(800,600),pContext);
	
	m_pMainView = (CMaptoolView*)m_MainSplitte.GetPane(0,1);
